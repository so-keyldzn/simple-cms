...
import { moveMediaToFolder, getAllFolders, createFolder, type MediaFolderWithChildren, deleteFolder } from "@/features/admin/lib/folder-actions";
import { Loader2, Folder, FolderPlus } from "lucide-react";
import type { MediaItem } from "../items/media-card";
import type { FolderItem } from "../items/folder-card";
import { MediaListItem } from "../items/media-list-item";
import { FolderListItem } from "../items/folder-list-item";
...
export function MediaListView({ media, folders = [], currentFolderId, onNavigateToFolder, onRefresh }: MediaListViewProps) {
	...
	return (
		<>
			<Card>
				<CardContent className="p-0">
					<div className="divide-y">
						{/* List header */}
						<div className="hidden md:flex items-center gap-4 px-4 py-2 text-xs font-medium text-muted-foreground bg-muted/50">
							<div className="w-12"></div> {/* Checkbox space */}
							<div className="w-12"></div> {/* Thumbnail space */}
							<div className="flex-1">{t("admin.media.name")}</div>
							<div className="w-24">{t("admin.media.type")}</div>
							<div className="hidden lg:block w-32">{t("admin.media.uploadedDate")}</div>
							<div className="hidden xl:block w-32">{t("admin.media.uploadedBy")}</div>
			...
			{/* All the same dialogs as grid view */}
			{/* Rename Dialog */}
			...
			{/* Move to Folder Dialog - Same as grid view */}
